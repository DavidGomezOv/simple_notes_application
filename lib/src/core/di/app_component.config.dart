...
extension GetItInjectableX on _i1.GetIt {
  ...
  _i1.GetIt $appInitGetIt({
    ...
    gh.lazySingleton<_i9.NoteDetailLocalSource>(
        () => _i9.NoteDetailLocalSource.from());
    gh.factory<_i10.NoteDetailRepository>(
        () => _i10.NoteDetailRepository.from(gh<_i9.NoteDetailLocalSource>()));
    gh.lazySingleton<_i11.NoteDetailService>(
        () => _i11.NoteDetailService.from(gh<_i10.NoteDetailRepository>()));
    gh.lazySingleton<_i12.NoteImagesDetailService>(
        () => _i12.NoteImagesDetailService.from());
    return this;
  }
}

class _$HelperModule extends _i13.HelperModule {
  @override
