...
extension GetItInjectableX on _i1.GetIt {
  ...
  _i1.GetIt $appInitGetIt({
    ...
    gh.lazySingleton<_i5.NoteDetailFirestoreSource>(
        () => _i5.NoteDetailFirestoreSource.from());
    gh.factory<_i6.NoteDetailRepository>(() =>
        _i6.NoteDetailRepository.from(gh<_i5.NoteDetailFirestoreSource>()));
    gh.lazySingleton<_i7.HomeFirestoreSource>(
        () => _i7.HomeFirestoreSource.from());
    gh.factory<_i8.HomeRepository>(
        () => _i8.HomeRepository.from(gh<_i7.HomeFirestoreSource>()));
    gh.lazySingleton<_i9.HomeService>(
        () => _i9.HomeService.from(gh<_i8.HomeRepository>()));
    gh.lazySingleton<_i10.NoteDetailService>(
        () => _i10.NoteDetailService.from(gh<_i6.NoteDetailRepository>()));
    return this;
  }
}

class _$HelperModule extends _i11.HelperModule {
  @override
